    ...
    return (
        ...
        >
            <View style={styles.mainTextContainer}>
                ...
                <Text style={{ ...styles.text, color: currentTheme.mainColor }}>
                    The names and dates you enter and the pictures you select
                    are stored only on your device and are not shared with any
                ...
                <Text style={{ ...styles.text, color: currentTheme.mainColor }}>
                    If you experience any issues, have any ideas to make this
                    app better or just want to give us feedback, feel free to
                    contact us at:
                </Text>
